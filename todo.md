...
> **TODO (manuell testen):** Stripe-Migration auf Checkout Sessions API testen - kompletten Checkout-Flow durchspielen (inkl. Stripe CLI Webhook-Weiterleitung: `stripe listen --forward-to localhost:5173/api/stripe/webhook`). Sicherstellen, dass Bestellstatus nach erfolgreicher Zahlung auf "confirmed / paid" gesetzt wird und die Bestätigungs-E-Mail ankommt.
